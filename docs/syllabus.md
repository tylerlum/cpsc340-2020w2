...
See the [Python info](python_info.md) and [git info](git_installation.md) documents. You also need a way of compiling LaTeX documents, ideally by installing LaTeX locally. But a cloud platform like [Overleaf](https://www.overleaf.com/) might work too.
...
All homework submission will take place through GitHub. See the [homework submission instructions](homework_instructions.md) document for more info.
